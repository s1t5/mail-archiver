...
namespace MailArchiver.Services
{
    public class SelectedEmailsExportService : BackgroundService, ISelectedEmailsExportService
    {
        ...
        private async Task ProcessEmailsForEmlExport(SelectedEmailsExportJob job, MailArchiverDbContext context, ZipArchive archive, string folderName, bool isOutgoing, CancellationToken cancellationToken)
        {
            var emails = context.ArchivedEmails
                .Where(e => job.EmailIds.Contains(e.Id) && e.IsOutgoing == isOutgoing)
        ...
        private async Task ProcessEmailsForMBoxExport(SelectedEmailsExportJob job, MailArchiverDbContext context, Stream mboxStream, bool isOutgoing, CancellationToken cancellationToken)
        {
